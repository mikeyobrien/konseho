...
def generate_diff(
    original: str, modified: str, filename: str = "file", context_lines: int = 3
) -> str:
...
def generate_inline_diff(
    original: str, modified: str, filename: str = "file", max_width: int = 80
) -> str:
...
def summarize_changes(original: str, modified: str) -> str:
    ...
    return (
        f"Changes: {added} lines added, {removed} lines removed, "
