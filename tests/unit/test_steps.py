...
class TestDebateStep:
    ...
    async def test_debate_with_moderator(self):
        ...
        step = DebateStep(
            [agent1, agent2], moderator=moderator, voting_strategy="moderator"
        )
        context = Context()
...
class TestSplitStep:
    ...
    async def test_split_fixed_strategy(self):
        ...
        step = SplitStep(
            agent_template=template, min_agents=3, max_agents=10, split_strategy="fixed"
        )
        context = Context()
    ...
    async def test_split_auto_strategy(self):
        ...
        step = SplitStep(
            agent_template=template, min_agents=2, max_agents=5, split_strategy="auto"
        )
        context = Context()
    ...
    async def test_split_max_agents_limit(self):
        ...
        step = SplitStep(
            agent_template=template, min_agents=2, max_agents=3, split_strategy="auto"
        )
        context = Context()
    ...
    async def test_split_task_distribution(self):
        ...
        step = SplitStep(agent_template=template, min_agents=3, split_strategy="fixed")
        context = Context()
