...
class TestQueryAnalyzer:
    ...
    def test_complexity_estimation(self):
        ...
        test_cases = [
            ...
            (
                "design and implement a distributed system with multiple microservices and ensure high availability",
                "high",
            ),
        ]
    ...
    def test_parallel_work_detection(self):
        ...
        result = self.analyzer.analyze(
            "research technical and business aspects of cloud migration"
        )
