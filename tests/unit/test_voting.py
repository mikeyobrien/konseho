...
class TestDebateVoting:
    ...
    async def test_majority_voting(self):
        ...
        with patch.object(agent1, 'work_on', new_callable=AsyncMock) as mock1, \
    ...
    async def test_consensus_voting(self):
        ...
        with patch.object(agent1, 'work_on', new_callable=AsyncMock) as mock1, \
            ...
            mock1.side_effect = ["Proposal A", "I vote for: Proposal A", 
                                "Revised Proposal A", "I vote for: Revised Proposal A"]
    ...
    async def test_weighted_voting(self):
        ...
        intermediate = AgentWrapper(MockStrandsAgent("intermediate"), expertise_level=0.5)
        novice = AgentWrapper(MockStrandsAgent("novice"), expertise_level=0.2)
        
        with patch.object(expert, 'work_on', new_callable=AsyncMock) as mock1, \
