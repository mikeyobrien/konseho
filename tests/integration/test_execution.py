...
class TestFullCouncilExecution:
    ...
    async def test_simple_council_execution(self):
        ...
        council = factory.create_council(
            name="simple_council", steps=[ParallelStep([agent1, agent2])]
        )
...
class TestAsyncExecutor:
    ...
    async def test_executor_parallel_councils(self):
        ...
        for i, result in enumerate(results):
            ...
            agent_output = (
                next(iter(parallel_results.values())) if parallel_results else ""
            )
    ...
    async def test_executor_error_handling(self):
        ...
        councils = [
            ...
            factory.create_council(
                "bad", [ParallelStep([AgentWrapper(FailingAgent())])]
            ),
